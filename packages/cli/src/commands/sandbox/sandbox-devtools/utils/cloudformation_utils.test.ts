...
void describe('createFriendlyName function', () => {
  ...
  void it('extracts friendly name from nested stack logical ID', () => {
    const nestedStackId = 'amplifyAuth-sandbox-12345678-NestedStack';
    assert.strictEqual(createFriendlyName(nestedStackId), 'Auth stack');
  });
